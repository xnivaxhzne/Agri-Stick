...
conn = sqlite3.connect('agristick.db',check_same_thread=False)
c = conn.cursor()
...
def update_graph_live(n_intervals):
    ...
    c.execute('SELECT * from sendata ORDER BY id DESC LIMIT 10 OFFSET 0')
    conn.commit()
    data = c.fetchall()
...
if __name__ == '__main__':
    app.run_server(host='192.168.201.4',port=8036)
